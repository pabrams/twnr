...
export const connectDB = async (): Promise<void> => {
    ...
    try {
      ...
      CREATE TABLE IF NOT EXISTS universe_template (
        ...
        seeker_victim_notice_pct SMALLINT NOT NULL DEFAULT ${universeConfig.seekerVictimNoticePct},
