...
export const MENU_REGISTRY: MenuEntry[] = [
    ...
    },
    {
        ...
        commands: [
            {
                command: 'buy_terraform_device',
                keyPattern: 't',
                label: 'Terraform Device',
                targetMenu: null,
                sortOrder: 10,
            },
            {
                command: 'buy_planet_buster',
                keyPattern: 'b',
                label: 'Planet Buster',
                targetMenu: null,
                sortOrder: 20,
            ...
            {
                command: 'buy_mines_menu',
                keyPattern: 'm',
                label: 'Mines (proximity/limpet)',
                targetMenu: null,
                sortOrder: 90,
            },
            {
                command: 'buy_hyperspace_1',
                keyPattern: '1',
                label: 'Hyperspace I',
                targetMenu: null,
                sortOrder: 100,
