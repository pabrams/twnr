...
const SAMPLES: Record<string, Record<string, unknown>> = {
    ...
    'PLANET.takeColonistsHeader': { qty: '1,000', commodity: 'fuel' },
    'PLANET.leaveColonistsHeader': { qty: '1,000', commodity: 'fuel' },
    'PLANET.planetColonistsLine': { count: '5,000' },
    'PLANET.shipColonistsLine': { count: 100 },
    'PLANET.landedHeader': { name: 'Earth' },
    'PLANET.displayTitle': { id: 1, sector: 42, name: 'Earth' },
    'PLANET.displayClass': { class: 'M', type: 'Terran' },
    'PLANET.displayOwner': { owner: 'Alice' },
    'PLANET.displayTableRow': {
        item: 'Fuel Ore ',
        colos: '    1,000',
        c2b1: '       10',
        hourly: '      100',
    ...
    'PLANET.displayHolds': { holds: 20 },
    'PLANET.listRow': { sector: 42, name: 'Earth', type: 'Terran' },
    'PLANET.listColonists': { fuel: 100, organics: 200, equipment: 150, drones: 25 },
    ...
    'EVENT.terraformDevicesAvailable': { count: 3 },
